...
(function(){
  ...
  document.querySelectorAll('.pill-section').forEach(root=>{
    ...
    const cfg = {
      ...
      nameEng:        root.dataset.hoverNameEng || 'dd-pill/dd_name_eng.png',
      infoEng:        root.dataset.hoverInfoEng || 'dd-pill/dd_info_eng.png',
      nameIta:        root.dataset.hoverNameIta || 'dd-pill/dd_name_ita.png',
      infoIta:        root.dataset.hoverInfoIta || 'dd-pill/dd_info_ita.png',
    };
