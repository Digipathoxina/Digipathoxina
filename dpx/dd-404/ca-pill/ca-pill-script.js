...
(function(){
  ...
  document.querySelectorAll('.pill-section').forEach(root=>{
    ...
    const cfg = {
      ...
      nameEng:        root.dataset.hoverNameEng || 'ca-pill/ca_name_eng.png',
      infoEng:        root.dataset.hoverInfoEng || 'ca-pill/ca_info_eng.png',
      nameIta:        root.dataset.hoverNameIta || 'ca-pill/v_name_ita.png',
      infoIta:        root.dataset.hoverInfoIta || 'ca-pill/ca_info_ita.png',
    };
